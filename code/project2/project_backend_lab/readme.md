...
- The airports of the world are located in a src\\main\\resources\\static\\sqlscripts
...
- Credentials : username:student, password : 123, username:vinsys, password:123
- POST : http://localhost:8080/auth/generateToken ,body : {'username':'vinsys','password:'123'}
- GET : http://localhost:8080/airports/bytype/small_airport (pass the token generated )
